...
- Operational resilience and response-boundary follow-ups #85, #62, #58, and #82 are complete.
  The active product milestone is #78: generate a dark/light static pair from one observed GitHub
  snapshot, then move the profile consumer from two independent fetches to that atomic bundle.
