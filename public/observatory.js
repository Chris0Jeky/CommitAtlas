...
const config = {"id":"commitatlas","project":{"label":"CommitAtlas","origin":"https://commit-atlas.commit-atlas.workers.dev","probe":{"url":"https://commit-atlas.commit-atlas.workers.dev/","marker":"CommitAtlas"},"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms","studio.opened","card.exported"],"routes":["home","studio","other"],"releases":["unattributed"],"measurements":["duration.ms"],"dailyLimit":1000},"origin":"https://commit-atlas.commit-atlas.workers.dev","endpoint":"","scopePath":"/","release":"unattributed","route":"home","clicks":[]};
